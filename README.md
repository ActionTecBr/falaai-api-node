# FalaAI API Node.js / TypeScript SDK - Speech-to-Text, Call Analytics & Compliance Audit

[![version](https://img.shields.io/npm/v/falaai-api)](https://www.npmjs.com/package/falaai-api)
...
Official Node.js / TypeScript SDK for the **FalaAI API** - call transcription, conversation intelligence and compliance auditing (**COPC CX**, **ISO 18295-1**).
...
Evolution API - WAHA - Typebot - Take Blip - Z-API - Chatpro - Zendesk - Rocket.Chat - HubSpot - Twilio - Telegraf
